...
#pragma unroll 1
  ...
  // Explicit instantiation for scalar type
  template cudaError_t generate_external_twiddles_generic(
    const scalar_rns_t& basic_root,
    scalar_rns_t* external_twiddles,
    scalar_rns_t*& internal_twiddles,
    scalar_rns_t*& basic_twiddles,
    uint32_t log_size,
    cudaStream_t& stream);
  ...
  template cudaError_t mixed_radix_ntt<scalar_rns_t, scalar_rns_t>(
    const scalar_rns_t* d_input,
    scalar_rns_t* d_output,
    scalar_rns_t* external_twiddles,
    scalar_rns_t* internal_twiddles,
    scalar_rns_t* basic_twiddles,
    scalar_rns_t* linear_twiddles,
