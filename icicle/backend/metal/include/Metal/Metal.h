...
/*
 * Create a SharedPtr by transferring the ownership of an existing raw pointer to SharedPtr.
...
using SharedEventNotificationBlock = void (^)(SharedEvent* prevent, std::uint64_t value);
