...
- [Full C++ example](https://github.com/ingonyama-zk/open-icicle/tree/main/examples/c++/install-and-use-icicle)
- [Full Rust example](https://github.com/ingonyama-zk/open-icicle/tree/main/examples/rust/install-and-use-icicle)
- [Full Go example](https://github.com/ingonyama-zk/open-icicle/tree/main/examples/golang/install-and-use-icicle)

1. **Extract and install the Tar Files**:

   - [Download](https://github.com/ingonyama-zk/open-icicle/releases) the appropriate tar files for your distribution (Ubuntu 20.04, Ubuntu 22.04, or UBI 8,9 for RHEL compatible binaries).
...
MCP Server URL (https://gitmcp.io//ingonyama-zk/open-icicle)
...
```Cursor
{
  "mcpServers": {
    "icicle Docs": {
      "url": "https://gitmcp.io//ingonyama-zk/open-icicle"
    }
  }
}
```
...

{
  "mcpServers": {
    "icicle Docs": {
      ...
      "args": [
        "mcp-remote",
        "https://gitmcp.io//ingonyama-zk/open-icicle"
      ]
    }
  }
}
