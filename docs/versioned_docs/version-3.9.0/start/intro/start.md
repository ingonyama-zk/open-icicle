...
:::important Scope of this open-icicle distribution
This documentation site covers the **open-icicle** distribution of ICICLE, which ships **only**:
...
Only the **BN254** and **BLS12-381** curves are supported. Other curves (BLS12-377, BW6-761, Grumpkin), prime fields (babybear, stark252, m31, koalabear), and primitives outside this list (e.g. Poseidon, Merkle trees, polynomial APIs, sumcheck, FRI, hash, pairings) are **not** included in this distribution. Where upstream ICICLE documentation references those, they do not apply here.
:::
...
<div className="card-grid">
  ...
  <Link to="/start/programmers_guide/general" className="card-link">
    <div className="card-box">
      ...
      <p>Consistent cryptographic APIs: MSM, NTT, ECNTT, vector ops.</p>
    </div>
  </Link>
  ...
  <Link to="/apioverview" className="card-link">
    <div className="card-box">
      ...
      <h3>API</h3>
      <p>Core ICICLE APIs: MSM, NTT, ECNTT with examples.</p>
    </div>
  </Link>
