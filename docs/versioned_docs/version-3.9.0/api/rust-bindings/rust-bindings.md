...
icicle-runtime = { git = "https://github.com/ingonyama-zk/open-icicle.git" }
icicle-core = { git = "https://github.com/ingonyama-zk/open-icicle.git" }
icicle-bn254 = { git = "https://github.com/ingonyama-zk/open-icicle.git" }
```
