...
const ingoPreset = {
  docs: {
    ...
    editUrl: 'https://github.com/ingonyama-zk/open-icicle/tree/main/docs',
  },
  blog: {
    remarkPlugins: [math],
    rehypePlugins: [katex],
    showReadingTime: true,
    editUrl: 'https://github.com/ingonyama-zk/open-icicle/tree/main',
  },
  pages: {},
  theme: {
...
const navBarLeftSide = [
  ...
  },
  {
    ...
    position: 'left',
    value: `
      <a href="https://github.com/ingonyama-zk/open-icicle"
