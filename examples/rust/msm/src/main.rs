...
use icicle_bls12_381::curve::{
    G1Projective as BLS12381G1Projective, ScalarField as BLS12381ScalarField,
};
...
fn main() {
    ...
    let upper_points_bls12381 = <BLS12381G1Projective as Projective>::Affine::generate_random(upper_size);
    let upper_scalars_bls12381 = BLS12381ScalarField::generate_random(upper_size);
