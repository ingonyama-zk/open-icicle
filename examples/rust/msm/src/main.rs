...
// Using both bn254 and bls12-381 curves
use icicle_bls12_381::curve::{
    CurveCfg as BLS12381CurveCfg, G1Projective as BLS12381G1Projective, ScalarCfg as BLS12381ScalarCfg,
};
...
fn main() {
    ...
    let upper_points_bls12381 = BLS12381CurveCfg::generate_random_affine_points(upper_size);
    let upper_scalars_bls12381 = BLS12381ScalarCfg::generate_random(upper_size);
    ...
    for i in lower_bound..=upper_bound {
        ...
        let points_bls12381 = HostSlice::from_slice(&upper_points_bls12381[..size]);
        let scalars_bls12381 = HostSlice::from_slice(&upper_scalars_bls12381[..size]);
        ...
        println!("Configuring bls12381 MSM...");
        let mut msm_results_bls12381 = DeviceVec::<BLS12381G1Projective>::device_malloc(1).unwrap();
        let mut stream_bls12381 = IcicleStream::create().unwrap();
        let mut cfg_bls12381 = msm::MSMConfig::default();
        cfg_bls12381.stream_handle = *stream_bls12381;
        cfg_bls12381.is_async = true;

        println!("Executing bn254 MSM on device...");
        msm::msm(scalars, points, &cfg, &mut msm_results[..]).unwrap();
        msm::msm(scalars, g2_points, &g2_cfg, &mut g2_msm_results[..]).unwrap();

        println!("Executing bls12381 MSM on device...");
        msm::msm(
            scalars_bls12381,
            points_bls12381,
            &cfg_bls12381,
            &mut msm_results_bls12381[..],
        )
        .unwrap();
        ...
        let mut msm_host_result_bls12381 = vec![BLS12381G1Projective::zero(); 1];
        ...
        stream_bls12381
            .synchronize()
            .unwrap();
        msm_results_bls12381
            .copy_to_host(HostSlice::from_mut_slice(&mut msm_host_result_bls12381[..]))
            .unwrap();
        println!("bls12381 result: {:#?}", msm_host_result_bls12381);
